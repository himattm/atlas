...
pub const CONFIG_SCHEMA_VERSION: &str = "atlas.config.v1";
pub const SCREEN_SCHEMA_VERSION: &str = "atlas.screen.v1";
pub const EDGE_SCHEMA_VERSION: &str = "atlas.edge.v1";
pub const ROUTE_SCHEMA_VERSION: &str = "atlas.route.v1";
pub const PROPOSAL_SCHEMA_VERSION: &str = "atlas.proposal.v1";
pub const RESULT_SCHEMA_VERSION: &str = "atlas.result.v1";
